...
if [ -d "./res/apk/assets/bin/" ]; then
  ...
  mv ./res/apk/assets/RawAssets/GamePlayBGVideo/*.mp4 ./res/export/videos
  rm -rf ./res/apk/assets/RawAssets/GamePlayBGVideo
fi

mv ./res/apk/assets/RawAssets/*_ending*.mp4 ./res/export/videos
mv ./res/apk/assets/RawAssets/*Cutscene.mp4 ./res/export/videos
mv ./res/apk/assets/RawAssets/eos*.mp4      ./res/export/videos
